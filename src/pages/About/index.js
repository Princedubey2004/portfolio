    ...
    <div className="parent pt-16 my-16">
      <div className="">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-20">
          ...
          >
            <h1 className="text-4xl font-semibold mb-4 text-center translate-y-[-380%] sm:translate-y-[-0%] sm:text-3xl sm:mb-2 md:text-left">Your Name</h1>
            <div className="my-8">
              <TypeAnimation
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-x-12 gap-y-4 mt-4 text-center translate-y-[-50%] sm:translate-y-[-0%] sm:mb-2 md:text-left ">
              <h2 className="font-medium">
                <span className="mr-2 text-primary">Name : </span>Your Name
              </h2>
              <h2 className="font-medium">
                <span className="mr-2 text-primary">Phone : </span>+1 234 567 8900
              </h2>
              <h2 className="font-medium">
              ...
              <h2 className="font-medium">
                <span className="mr-2 text-primary">Address : </span>Your City, Country
              </h2>
              <a
                href="#"
                target="blank"
